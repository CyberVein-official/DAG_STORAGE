...
public class GetNeighborsResponse extends AbstractResponse {
    ...
    static class Neighbor {
        ...
        public static Neighbor createFrom(com.cvt.iri.network.Neighbor n) {
    ...
    public static AbstractResponse create(final List<com.cvt.iri.network.Neighbor> elements) {
        GetNeighborsResponse res = new GetNeighborsResponse();
        res.neighbors = new Neighbor[elements.size()];
        int i = 0;
        for (com.cvt.iri.network.Neighbor n : elements) {
