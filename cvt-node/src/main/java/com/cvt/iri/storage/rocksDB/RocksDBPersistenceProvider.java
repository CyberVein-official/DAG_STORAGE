package com.cvt.iri.storage.rocksDB;

import com.cvt.iri.model.*;
import com.cvt.iri.storage.Indexable;
import com.cvt.iri.storage.Persistable;
import com.cvt.iri.storage.PersistenceProvider;
...
public class RocksDBPersistenceProvider implements PersistenceProvider {
    ...
    private ColumnFamilyHandle balanceHandle;
    ...
    private void initClassTreeMap() {
        ...
        classMap.put(LongPersistable.class, balanceHandle);
    ...
    private void fillModelColumnHandles() throws Exception {
        ...
        balanceHandle = columnFamilyHandles.get(++i);
    ...
    public Map<Class<?>, ColumnFamilyHandle> getClassTreeMap() {
        return classTreeMap;
    }
