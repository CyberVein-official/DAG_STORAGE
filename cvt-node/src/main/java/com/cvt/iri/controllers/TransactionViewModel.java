...
import com.cvt.iri.model.Approvee;
...
public class TransactionViewModel {
    ...
    private final com.cvt.iri.model.Transaction transaction;
    ...
    public void setAddressHash(Hash addressHash) {
        this.transaction.address = addressHash;
    }
    ...
    public Hash getMessageValue() {
        return new Hash(getSignature(), SIGNATURE_MESSAGE_FRAGMENT_TRINARY_OFFSET, SIGNATURE_MESSAGE_FRAGMENT_TRINARY_SIZE);
    }
